...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dask-snowflake-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13879&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dask-snowflake-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dask-snowflake` can be installed with:

```
conda install dask-snowflake
```

It is possible to list all of the versions of `dask-snowflake` available on your platform with:
